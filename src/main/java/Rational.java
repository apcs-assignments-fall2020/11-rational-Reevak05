public class Rational
{
    ...
    {
        int newNumerator = r.numerator/greatestCommonFactor(r.numerator, r.denominator);
        int newDenominator = r.denominator/greatestCommonFactor(r.numerator, r.denominator);
        Rational x = new Rational(newNumerator, newDenominator);
        return x;
    }
